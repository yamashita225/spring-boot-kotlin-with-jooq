...
import com.example.jooq.keys.BOOK_AUTHOR_PKEY
...
open class BookAuthor(
     ...
     */
    val BOOK_ID: TableField<BookAuthorRecord, Int?> = createField(DSL.name("book_id"), SQLDataType.INTEGER.nullable(false), this, "")

    /**
     * The column <code>public.book_author.author_id</code>.
     */
    val AUTHOR_ID: TableField<BookAuthorRecord, Int?> = createField(DSL.name("author_id"), SQLDataType.INTEGER.nullable(false), this, "")
